...
angular.module('courses').run(['Menus', function(Menus) {
	...
	Menus.addMenuItem('topbar', 'Courses', 'courses', 'dropdown', '/courses(/create)?', false, ['admin', 'teacher']);
	Menus.addSubMenuItem('topbar', 'courses', 'List', 'courses', 'courses', false, ['admin']);
