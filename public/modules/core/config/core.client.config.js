...
angular.module('core').run(['Menus', function(Menus) {
	...
	Menus.addMenuItem('topbar', 'MENU.MANAGE', 'manage', 'dropdown', '/manage', false, ['admin', 'manager', 'printer']);
	Menus.addMenuItem('topbar', 'MENU.TOOLS', 'tools', 'dropdown', '/tools', false, ['admin']);
}]);
